...
For this ctf, we have 3 questions, and the first 2 are very helpful for finding and exploiting the vulnerabilities that this site has.
...
The last line of the output is the one where I could see the flag:
